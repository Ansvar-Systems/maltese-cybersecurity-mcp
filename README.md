...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fmaltese-cybersecurity-mcp.svg)](https://www.npmjs.com/package/@ansvar/maltese-cybersecurity-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/maltese-cybersecurity/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add maltese-cybersecurity-mcp --transport http https://mcp.ansvar.eu/maltese-cybersecurity/mcp` |
...
```json
{
  "mcpServers": {
    "maltese-cybersecurity-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/maltese-cybersecurity/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/maltese-cybersecurity-mcp
```
...
```json
{
  "mcpServers": {
    "maltese-cybersecurity-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/maltese-cybersecurity-mcp"]
    }
  }
}
```
