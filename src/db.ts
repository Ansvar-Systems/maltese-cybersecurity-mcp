/**
 * SQLite database access layer for the Maltese Cybersecurity (CSI Malta) MCP server.
 *
 * Schema:
 *   - guidance    — CSI Malta cybersecurity guidelines and technical standards
 *   - advisories  — CSI Malta security advisories and incident alerts
 *   - frameworks  — CSI Malta framework series (NIS2 guidance, national cybersecurity strategy)
 *
