      ...
      switch (name) {
        ...
        case "mt_cyber_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "CSI Malta (Cybersecurity Intelligence Malta) and MITA MCP server. Provides access to BSI technical guidelines, IT-Grundschutz building blocks, BSI Standards, and security advisories.",
